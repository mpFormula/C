...
extern void mpNum_Std_Functions0(long what, mpNum_t y)
{
   if ((y->NumType) > 0)
   {
        switch (y->NumType) {
            case mp_const_mpType_Single: {Std_Float_Functions0(what, y->NumPtr);} break;
            case mp_const_mpType_Double: {Std_Double_Functions0(what, y->NumPtr);} break;
            case mp_const_mpType_LongDouble: {Std_LongDouble_Functions0(what, y->NumPtr);} break;
            case mp_const_mpType_Mpfr: {Std_Mpfr_Functions0(what, y->NumPtr);} break;
            case mp_const_mpType_Mpfi: {Std_Mpfi_Functions0(what, y->NumPtr);} break;
            case mp_const_mpType_Mpdec: {Std_Mpdec_Functions0(what, y->NumPtr);} break;
            case mp_const_mpType_Mpq: {Std_Mpq_Functions0(what, y->NumPtr);} break;
...
extern void mpNum_Std_Functions1(long what, mpNum_t y, mpNum_t x0)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {Std_Float_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Double: {Std_Double_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_LongDouble: {Std_LongDouble_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpfr: {Std_Mpfr_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpfi: {Std_Mpfi_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpdec: {Std_Mpdec_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpq: {Std_Mpq_Functions1(what, y->NumPtr, x0->NumPtr);} break;
...
extern void mpNum_Std_Functions2(long what, mpNum_t y, mpNum_t x0, mpNum_t x1)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {Std_Float_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Double: {Std_Double_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_LongDouble: {Std_LongDouble_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpfr: {Std_Mpfr_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpfi: {Std_Mpfi_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpdec: {Std_Mpdec_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpq: {Std_Mpq_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
        }
   }
   else
   {
...
extern void mpNum_Std_Functions3(long what, mpNum_t y, mpNum_t x0, mpNum_t x1, mpNum_t x2)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {Std_Float_Functions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Double: {Std_Double_Functions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_LongDouble: {Std_LongDouble_Functions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpfr: {Std_Mpfr_Functions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpfi: {Std_Mpfi_Functions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpdec: {Std_Mpdec_Functions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpq: {Std_Mpq_Functions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
        }
   }
   else
   {
...
extern void mpNum_Std_Functions1_2Results(long what, mpNum_t y0, mpNum_t y1, mpNum_t x0)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {Std_Float_Functions2(what, y0->NumPtr, y1->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Double: {Std_Double_Functions2(what, y0->NumPtr, y1->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_LongDouble: {Std_LongDouble_Functions2(what, y0->NumPtr, y1->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpfr: {Std_Mpfr_Functions2(what, y0->NumPtr, y1->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpfi: {Std_Mpfi_Functions2(what, y0->NumPtr, y1->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpdec: {Std_Mpdec_Functions2(what, y0->NumPtr, y1->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpq: {Std_Mpq_Functions2(what, y0->NumPtr, y1->NumPtr, x0->NumPtr);} break;
...
extern void mpNum_Std_Functions2_2Results(long what, mpNum_t y0, mpNum_t y1, mpNum_t x0, mpNum_t x1)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {Std_Float_Functions3(what, y0->NumPtr, y1->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Double: {Std_Double_Functions3(what, y0->NumPtr, y1->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_LongDouble: {Std_LongDouble_Functions3(what, y0->NumPtr, y1->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpfr: {Std_Mpfr_Functions3(what, y0->NumPtr, y1->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpfi: {Std_Mpfi_Functions3(what, y0->NumPtr, y1->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpdec: {Std_Mpdec_Functions3(what, y0->NumPtr, y1->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpq: {Std_Mpq_Functions3(what, y0->NumPtr, y1->NumPtr, x0->NumPtr, x1->NumPtr);} break;
...
extern void mpNum_cplx_Functions1(long what, mpNum_t y, mpNum_t x0)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {Std_Float_cplx_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Double: {Std_Double_cplx_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_LongDouble: {Std_LongDouble_cplx_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpfr: {Std_Mpfr_cplx_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpfi: {Std_Mpfi_cplx_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpdec: {Std_Mpdec_cplx_Functions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpq: {Std_Mpq_cplx_Functions1(what, y->NumPtr, x0->NumPtr);} break;
        }
   }
   else
   {
...
extern void mpNum_cplx_Functions2(long what, mpNum_t y, mpNum_t x0, mpNum_t x1)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {Std_Float_cplx_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Double: {Std_Double_cplx_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_LongDouble: {Std_LongDouble_cplx_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpfr: {Std_Mpfr_cplx_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpfi: {Std_Mpfi_cplx_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpdec: {Std_Mpdec_cplx_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpq: {Std_Mpq_cplx_Functions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
        }
   }
   else
   {
...
extern void mpNum_ElementaryFunctions1(long what, mpNum_t y, mpNum_t x0)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {boost_Float_ElementaryFunctions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Double: {boost_Double_ElementaryFunctions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_LongDouble: {boost_LongDouble_ElementaryFunctions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpfr: {boost_Mpfr_ElementaryFunctions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpfi: {boost_Mpfi_ElementaryFunctions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpdec: {boost_Mpdec_ElementaryFunctions1(what, y->NumPtr, x0->NumPtr);} break;
            case mp_const_mpType_Mpq: {boost_Mpq_ElementaryFunctions1(what, y->NumPtr, x0->NumPtr);} break;
        }
   }
   else
   {
...
extern void mpNum_ElementaryFunctions2(long what, mpNum_t y, mpNum_t x0, mpNum_t x1)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {boost_Float_ElementaryFunctions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Double: {boost_Double_ElementaryFunctions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_LongDouble: {boost_LongDouble_ElementaryFunctions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpfr: {boost_Mpfr_ElementaryFunctions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpfi: {boost_Mpfi_ElementaryFunctions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpdec: {boost_Mpdec_ElementaryFunctions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpq: {boost_Mpq_ElementaryFunctions2(what, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
        }
   }
   else
   {
...
extern void mpNum_ElementaryFunctions3(long what, mpNum_t y, mpNum_t x0, mpNum_t x1, mpNum_t x2)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {boost_Float_ElementaryFunctions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Double: {boost_Double_ElementaryFunctions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_LongDouble: {boost_LongDouble_ElementaryFunctions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpfr: {boost_Mpfr_ElementaryFunctions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpfi: {boost_Mpfi_ElementaryFunctions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpdec: {boost_Mpdec_ElementaryFunctions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpq: {boost_Mpq_ElementaryFunctions3(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;        }
   }
   else
   {
// Raise error
...
extern void mpNum_ElementaryFunctions4(long what, mpNum_t y, mpNum_t x0, mpNum_t x1, mpNum_t x2, mpNum_t x3)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {boost_Float_ElementaryFunctions4(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_Double: {boost_Double_ElementaryFunctions4(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_LongDouble: {boost_LongDouble_ElementaryFunctions4(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_Mpfr: {boost_Mpfr_ElementaryFunctions4(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_Mpfi: {boost_Mpfi_ElementaryFunctions4(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_Mpdec: {boost_Mpdec_ElementaryFunctions4(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_Mpq: {boost_Mpq_ElementaryFunctions4(what, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
        }
   }
   else
   {
...
extern void mpNum_DistributionFunctions2(long Dist, long Target, mpNum_t y, mpNum_t x0, mpNum_t x1)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {boost_Float_DistributionFunctions2(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Double: {boost_Double_DistributionFunctions2(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_LongDouble: {boost_LongDouble_DistributionFunctions2(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpfr: {boost_Mpfr_DistributionFunctions2(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpfi: {boost_Mpfi_DistributionFunctions2(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpdec: {boost_Mpdec_DistributionFunctions2(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
            case mp_const_mpType_Mpq: {boost_Mpq_DistributionFunctions2(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr);} break;
        }
   }
   else
   {
...
extern void mpNum_DistributionFunctions3(long Dist, long Target, mpNum_t y, mpNum_t x0, mpNum_t x1, mpNum_t x2)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {boost_Float_DistributionFunctions3(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Double: {boost_Double_DistributionFunctions3(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_LongDouble: {boost_LongDouble_DistributionFunctions3(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpfr: {boost_Mpfr_DistributionFunctions3(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpfi: {boost_Mpfi_DistributionFunctions3(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpdec: {boost_Mpdec_DistributionFunctions3(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
            case mp_const_mpType_Mpq: {boost_Mpq_DistributionFunctions3(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr);} break;
        }
   }
   else
   {
...
extern void mpNum_DistributionFunctions4(long Dist, long Target, mpNum_t y, mpNum_t x0, mpNum_t x1, mpNum_t x2, mpNum_t x3)
{
   if ((x0->NumType) > 0)
   {
        switch (x0->NumType) {
            case mp_const_mpType_Single: {boost_Float_DistributionFunctions4(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_Double: {boost_Double_DistributionFunctions4(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_LongDouble: {boost_LongDouble_DistributionFunctions4(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_Mpfr: {boost_Mpfr_DistributionFunctions4(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_Mpfi: {boost_Mpfi_DistributionFunctions4(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_Mpdec: {boost_Mpdec_DistributionFunctions4(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
            case mp_const_mpType_Mpq: {boost_Mpq_DistributionFunctions4(Dist, Target, y->NumPtr, x0->NumPtr, x1->NumPtr, x2->NumPtr, x3->NumPtr);} break;
        }
   }
   else
   {
