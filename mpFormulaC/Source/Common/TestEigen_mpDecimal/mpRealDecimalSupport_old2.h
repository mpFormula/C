...
namespace Eigen {
    ...
    : GenericNumTraits<mpDec::mpdec_class>
  {
    ...
    // Constants
    inline static Real Pi       (long Precision = mpDec::mpdec_class::get_default_prec())     {    return mpDec::const_pi(Precision);        }
    inline static Real Euler    (long Precision = mpDec::mpdec_class::get_default_prec())     {    return mpDec::const_euler(Precision);     }
    inline static Real Log2     (long Precision = mpDec::mpdec_class::get_default_prec())     {    return mpDec::const_log2(Precision);      }
    inline static Real Catalan  (long Precision = mpDec::mpdec_class::get_default_prec())     {    return mpDec::const_catalan(Precision);   }
    ...
    {
        unsigned int weak_prec = ((mpDec::mpdec_class::get_default_prec()-1) * 90) / 100;
